      ...
      for (uint64 i = 0; (i < numtrans) && numsalesrows; i++)
      {
            ...
            fnum <= numfiles)
        {
          ...
          if (numfiles == 1)
			...
			{
			  sprintf(filename, "%s/%s_%03d.tbl", datadirectory,"Store_Sales_Fact",fnum);
  ...
  while (numorderrows)
  {
         ...
         fnum <= numfiles)
    {
      ...
      if(numfiles == 1)
		...
		{
			sprintf(filename, "%s/%s_%03d.tbl", datadirectory,"Store_Orders_Fact",fnum);
      ...
      for (uint64 i = 0; (i < numtrans) && numinventoryrows; i++)
      {
            ...
            fnum <= numfiles)
        {
          ...
          if (numfiles == 1)
			...
			{
          		sprintf(filename, "%s/%s_%03d.tbl", datadirectory,"Inventory_Fact",fnum);
      ...
      for (uint64 i = 0; (i < numtrans) && numonlinesalesrows; i++)
      {
            ...
            fnum <= numfiles)
        {
          ...
          if (numfiles == 1)
			...
			{
          		sprintf(filename, "%s/%s_%03d.tbl", datadirectory,"Online_Sales_Fact",fnum);
